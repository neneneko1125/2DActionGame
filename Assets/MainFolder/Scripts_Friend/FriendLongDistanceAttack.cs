...
/// <summary>
/// 遠距離攻撃 Friendの遠距離キャラはInstanceデータが必要だから、インタフェースを利用してInstanceDataをもらう
/// </summary>
public class FriendLongDistanceAttack : CharacterLongDistanceAttack, ICharacterInitializer
{
